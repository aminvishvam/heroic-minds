                ...
                <div className="vertical-center ">
                    ...
                    <div className="text h16 lh150 text-black-079">
                        <p>
                            ...
                            2009 when he sustained a serious head injury that left him with
                            ...
                            surprising realization was that all the "stuff" wasn't really fixing
                            the problems. This is when Heroic Minds
                            <br />
                            <br />
                            ...
                            fuel, growing a blade of grass in the wind and rain without a strong
                            root in the ground or going on a hike with all the newest gadgets
                            and gizmos but forgetting a map.
                            <br />
                            <br />
                            Ben knows (and he believes the world also knows) there is need for a
                            catalytic shift in the approach to wellness and performance. It is
                            not that we need more tools, research and resources. What is needed
                            is the opportunity to develop a powerful inner compass (values &
                            spirit) that ultimately guide peoples behaviour in the direction of
                            the greatest good, for themselves and the world around them.
                            <br />
                        </p>
                    </div>
                </div>
            ...
            <div className="pt-4 pr-4">
                ...
                <div className="text h16 lh150 text-black-079">
                    <p>
                        ...
                        <br />
                        <br />
                        <button type="submit" className="btn pt-3 pb-3 pr-4 pl-4 btn-black ls1">
    ...
    render() {
        return (
            <div className="work-with-the-creator-page">
                ...
                <section className="mt-7  col-md-11 mx-auto">
                    <DisplayBox
                        colLeft="5"
                        colRight="7"
                ...
                <section className="mt-7">{this.renderVideo()}</section>
